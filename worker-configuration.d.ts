/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 289a1203764eca927fe9181f546a7ff7)
// Runtime types generated with workerd@1.20260831.1 2026-08-10 
interface __BaseEnv_Env {
	LOGGER_TYPE: "json" | "pretty";
	GROUPME_ACCESS_TOKEN: string;
	UNPIN_MANAGER: DurableObjectNamespace<import("./src/index").UnpinManager>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UnpinManager";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOGGER_TYPE" | "GROUPME_ACCESS_TOKEN">> {}
}
